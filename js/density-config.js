 ...
 * please modify density/package.json to control dependencies.
 *
 * RequireJS configuration file for the density sim.
...
require.config( {
  ...
  paths: {
    ...
    DENSITY: '.',
    DENSITY_BUOYANCY_COMMON: '../../density-buoyancy-common/js',
    DOT: '../../dot/js',
    JOIST: '../../joist/js',
    KITE: '../../kite/js',
    MOBIUS: '../../mobius/js',
